...
import { useCreateSubCourseMutation } from "@/app/redux/api/coursesApi";
...
const CreateSubCourse =()=>{
    ...
    const [createSubCourse,{isLoading, error, isSuccess}]=useCreateSubCourseMutation()    
    type Topic ={
        title:string,
        body:string,
        summary:string
    ...
    useEffect(()=>{
        ...
        if(isSuccess){
            ...
            navigate(`/admin/course/${params.id}`)
        }
    ...
    const handleSubmit =(e:React.FormEvent<HTMLFormElement>)=>{
        ...
        createSubCourse({id:params.id, body:formData})
    }
        ...
        <section className="flex flex-col sm:flex-row w-full h-full py-4 px-2 sm:p-8  overflow-y-auto">
            ...
            <div className="flex-1 ">
                <div className="flex items-center gap-4 px-2">
                    ...
                    <h1 className="font-bold text-[32px] text-slate-950 ">Create Sub Course</h1>
                </div>
