...
import { useLoginStudentMutation } from "../../../../app/redux/api/authApi";
...
const StudentLogin = () => {
  ...
  const [login, {isLoading, isSuccess, error}]=useLoginStudentMutation()
    ...
    <section className="w-full ">
      ...
      <div className="w-full flex justify-center items-center h-screen ">
          ...
          <div className="flex flex-col items-center justify-center bg-white w-full sm:w-[40%] px-6 sm:px-4 py-6 rounded-xl shadow ">
            ...
            <p className="text-sm text-gray-500 mt-2  ">Welcome Back to Our Student Dashboard </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full sm:w-[400px] mt-4 ">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    />
                  <IoMdMail size={20} className="absolute top-4 left-2 text-purple-700 " />
                </div>
              </div>
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full px-10 py-3 rounded-lg border-[1px] border-gray-300 outline-blue-900"
                    />
                  <MdPassword size={20} className="absolute top-4 left-2 text-purple-700 " />
                  {open ? 
                  <AiFillEye 
                    size={20}
              ...
              <button className="w-full px-6 py-3 bg-[#110c2e] hover:bg-gray-800 transition duration-150 shadow-md rounded-md text-white ">{isLoading? "Loading...":"Login"}</button>
              <div className="flex flex-col justify-center gap-4 items-center w-full mt-2">
                <p className="text-gray-600 text-sm cursor-pointer flex items-center gap-2"> Are you a facilitator? <Link to= {"/admin/login"} className="font-bold text-black ">Sign In </Link></p>
